...
Symptom1 = StringVar()
Symptom1.set("Choose From")

Symptom2 = StringVar()
Symptom2.set("Choose From")

Symptom3 = StringVar()
Symptom3.set("Choose From")

Symptom4 = StringVar()
Symptom4.set("Choose From")

Symptom5 = StringVar()
Symptom5.set("Choose From")

Name = StringVar()

w2 = Label(root, justify=LEFT, text="Risk Assess- risk assessment of diseases", fg="Red", bg="White")
w2.config(font=("Times",30,"bold italic"))
w2.grid(row=1, column=0, columnspan=2, padx=100)
w2 = Label(root, justify=LEFT, text="A Project of BE - GROUP 19",fg="Pink", bg="Blue")
w2.config(font=("Times",30,"bold italic"))
